...
export default async function Home({ params }: HomeProps) {
  ...
  const url = getLocalizedUrl(locale, "");
  const title = generateTitle(t("seoTitle"));
  const description = t("seoDescription");
  return (
    <>
      <PageJsonLd url={url} title={title} description={description} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div>
                  <h3 className="font-semibold text-foreground mb-2 text-2xl">
                    <span className="text-2xl">🔒</span> {t("private")}
                  </h3>
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2 text-2xl">
                    <span className="text-2xl">⚡</span> {t("fast")}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {t("fastDesc")}
                  </p>
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2 text-2xl">
                    <span className="text-2xl">🆓</span> {t("free")}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {t("freeDesc")}
                  </p>
