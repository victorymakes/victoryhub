...
const blogPosts = [
    {
        ...
        excerpt:
            "Discover the most essential development tools that every developer should know about in 2025.",
    ...
    },
    {
        ...
        excerpt:
            "A comprehensive guide to selecting the perfect design tool based on your team's needs and workflow.",
        author: "Mike Chen",
        date: "2025-01-12",
        readTime: "8 min read",
        category: "Design",
    ...
    },
    {
        ...
        excerpt:
            "Learn how to maximize your productivity using the latest productivity tools and techniques.",
        author: "Emma Davis",
        date: "2025-01-10",
        readTime: "6 min read",
    ...
    },
    {
        ...
        excerpt:
            "Exploring how artificial intelligence is transforming the development landscape.",
    ...
    },
    {
        ...
        excerpt:
            "How design systems and the right tools can help create consistent, scalable user experiences.",
        author: "Jessica Kim",
        date: "2025-01-05",
        readTime: "9 min read",
        category: "Design",
                ...
                <div>
                    ...
                    <div className="space-y-6">
                        {recentPosts.map((post) => (
                            <article
                                key={post.id}
                                className="bg-card rounded-lg shadow-sm p-6 flex flex-col md:flex-row md:items-center gap-6 border"
                            >
