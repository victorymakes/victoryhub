...
const formatTime = (minutes: number): string => {
  if (!Number.isFinite(minutes)) return "Infinite";
...
export default function SLOBurnSimulator() {
  ...
  const series = useMemo(() => {
    const throughput = throughputMode === "avg" ? avgThroughput : maxThroughput;
  ...
  const getExhaustionTime = useCallback(
    (rate: number): string => {
      ...
      const minutes = calculateTimeToExhaustion(errorBudget, rate, throughput);
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="slo-target">{t("sloTarget")} (%)</Label>
              <Input
                id="slo-target"
                type="number"
                step="0.01"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                min="1"
                value={sloWindow}
                onChange={(e) => setSloWindow(parseInt(e.target.value, 10))}
              />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="throughput-mode">{t("throughputMode")}</Label>
                <div className="flex items-center space-x-2">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      setThroughputMode(checked ? "max" : "avg");
                    }}
                  />
                  <span
                    className={
            ...
            {throughputMode === "max" && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    const value = parseInt(e.target.value, 10);
                    setMaxThroughput(Math.max(value, avgThroughput));
                  }}
                />
              </div>
            )}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex">
                  <Input
                    ...
                    onChange={(e) => setCustomErrorRate(e.target.value)}
            ...
            <div className="space-y-2 p-4 bg-muted rounded-md">
              <h3 className="text-md font-medium">{t("formulas")}</h3>
              <ul className="space-y-2 list-disc pl-5">
                <li>Error Budget Percent = (100 - SLO Target) / 100</li>
                <li>
                  Total Budget Errors = Events Per Min AVG * 60 * 24 * SLO
                  Window Days * Error Budget Percent
                </li>
                <li>
        ...
        <CardContent>
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h4 className="text-lg font-medium">{t("burnChart")}</h4>
            ...
            >
              ...
              >
                <div className="p-4 rounded-lg  flex flex-col items-center">
                  ...
                  <span className="text-2xl">{sloTarget}%</span>
                </div>
                <div className="p-4 rounded-lg  flex flex-col items-center">
                  <span className="text-xs text-muted-foreground">
                    {t("sloWindow")}
                ...
                <div className="p-4 rounded-lg  flex flex-col items-center">
                  ...
                  <span className="text-2xl">{avgThroughput}/m</span>
                </div>
                {throughputMode === "max" && (
                  <div className="p-4 rounded-lg  flex flex-col items-center">
                    <span className="text-xs text-muted-foreground">
                    ...
                    <span className="text-2xl">{maxThroughput}/m</span>
                  </div>
                )}
              </div>
                      ...
                      <span
                        ...
                        style={{
                          backgroundColor: getLineColor(
                            errorRates.length - 1 - index,
                          ),
                        }}
                      ></span>
                      <span className="font-medium">{rate}% Error:</span>
                    </div>
