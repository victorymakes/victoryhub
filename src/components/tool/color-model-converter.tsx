...
const oklabToLinearRgb = (
  ...
  const r_srgb = r <= 0.0031308 ? r * 12.92 : 1.055 * r ** (1 / 2.4) - 0.055;
  const g_srgb = g <= 0.0031308 ? g * 12.92 : 1.055 * g ** (1 / 2.4) - 0.055;
  const b_srgb = b_ <= 0.0031308 ? b_ * 12.92 : 1.055 * b_ ** (1 / 2.4) - 0.055;
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromRgb(value[0], rgb[1], rgb[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromRgb(rgb[0], value[0], rgb[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromRgb(rgb[0], rgb[1], value[0])
                    }
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromHsl(value[0], hsl[1], hsl[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromHsl(hsl[0], value[0], hsl[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromHsl(hsl[0], hsl[1], value[0])
                    }
                  />
                </div>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromHsv(value[0], hsv[1], hsv[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromHsv(hsv[0], value[0], hsv[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromHsv(hsv[0], hsv[1], value[0])
                    }
                  />
                </div>
              </div>
              <Button
                ...
                className="w-full"
                onClick={() =>
                  copyToClipboard(`hsv(${hsv[0]}, ${hsv[1]}%, ${hsv[2]}%)`)
                }
              >
                <Copy className="h-4 w-4" />
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.01}
                    onValueChange={(value) =>
                      updateFromOklab(value[0], oklab[1], oklab[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.01}
                    onValueChange={(value) =>
                      updateFromOklab(oklab[0], value[0], oklab[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.01}
                    onValueChange={(value) =>
                      updateFromOklab(oklab[0], oklab[1], value[0])
                    }
                  />
                </div>
              </div>
              ...
              >
                <Copy className="h-4 w-4" />
                oklab({oklab[0].toFixed(2)} {oklab[1].toFixed(2)}{" "}
                {oklab[2].toFixed(2)})
              </Button>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.01}
                    onValueChange={(value) =>
                      updateFromOklch(value[0], oklch[1], oklch[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.01}
                    onValueChange={(value) =>
                      updateFromOklch(oklch[0], value[0], oklch[2])
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={1}
                    onValueChange={(value) =>
                      updateFromOklch(oklch[0], oklch[1], value[0])
                    }
                  />
                </div>
              </div>
              ...
              >
                <Copy className="h-4 w-4" />
                oklch({oklch[0].toFixed(2)} {oklch[1].toFixed(2)}{" "}
                {Math.round(oklch[2])})
              </Button>
            </div>
          </CardContent>
