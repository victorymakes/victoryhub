...
import { AlertTriangle, Copy, Info, RefreshCw } from "lucide-react";
      ...
      <Card>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-3">
            <label htmlFor="predefined-select" className="text-sm font-medium">
              {t("predefinedExpressions")}
            </label>
            <Select onValueChange={(value) => setCronExpression(value)}>
              <SelectTrigger className="w-full">
                <SelectValue placeholder={t("selectExpression")} />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-3">
            <label htmlFor="cron-output" className="text-sm font-medium">
              {t("humanReadable")}
            </label>
            <div className="flex items-center gap-2">
              <Input
