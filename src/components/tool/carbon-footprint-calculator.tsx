...
export default function CarbonFootprintCalculator() {
  ...
  const calculateCarbonFootprint = useCallback(() => {
    ...
    if (
      ...
      Number.isNaN(flightsValue) ||
      Number.isNaN(householdValue)
    ) {
    ...
    const energyEmissions = energyFactors[energyEfficiency] / householdValue;
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setTransportationType(value as TransportationType)
                }
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value={TransportationType.PUBLIC_TRANSPORT}>
                    {t("transportationTypes.publicTransport")}
                  </SelectItem>
                  <SelectItem value={TransportationType.BIKE_WALK}>
                    {t("transportationTypes.bikeWalk")}
                  </SelectItem>
                  <SelectItem value={TransportationType.MIXED}>
            ...
            <div className="space-y-2">
              <Label htmlFor="flights-per-year">{t("flightsPerYear")}</Label>
              <Input
                id="flights-per-year"
                type="number"
                min={0}
            ...
            <div className="space-y-2">
              <Label htmlFor="energy-efficiency">{t("energyEfficiency")}</Label>
              <Select
                value={energyEfficiency}
                onValueChange={(value) =>
                  setEnergyEfficiency(value as EnergyEfficiency)
                }
              >
                <SelectTrigger id="energy-efficiency">
                  <SelectValue placeholder={t("selectEnergyEfficiency")} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value={EnergyEfficiency.LOW}>
                    {t("energyEfficiencyLevels.low")}
                  </SelectItem>
                  <SelectItem value={EnergyEfficiency.AVERAGE}>
                    {t("energyEfficiencyLevels.average")}
                  </SelectItem>
                  <SelectItem value={EnergyEfficiency.HIGH}>
                    {t("energyEfficiencyLevels.high")}
                  </SelectItem>
                  <SelectItem value={EnergyEfficiency.RENEWABLE}>
            ...
            <div className="space-y-2">
              <Label htmlFor="household-size">{t("householdSize")}</Label>
              <Input
                id="household-size"
                type="number"
                min={1}
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueChange={(value) => setConsumptionLevel(value[0])}
              />
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                <Label htmlFor="recycling-level">{t("recyclingLevel")}</Label>
                <span className="text-sm text-muted-foreground">
                  {recyclingLevel}%
                </span>
              </div>
              <Slider
                ...
                onValueChange={(value) => setRecyclingLevel(value[0])}
              />
              <p className="text-xs text-muted-foreground">
            ...
            <div className="flex space-x-2">
              <Button onClick={calculateCarbonFootprint} className="flex-1">
                {t("calculate")}
              </Button>
              <Button
        ...
        <Card className="shadow-lg border-2 border-gray-100">
          <CardContent className="pt-6">
            <div className="space-y-4">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-md font-medium mt-2">
                    ...
                    <span className="text-primary">
                      {getCarbonFootprintCategory(carbonFootprint)}
                    </span>
                  </p>
              ...
              <div>
                <h4 className="text-md font-medium">{t("reductionTips")}</h4>
