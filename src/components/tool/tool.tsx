...
> = {
  ...
  "text-favicon-generator": dynamic(() => import("./text-favicon-generator"), {
    loading: () => <ToolLoader />,
    ssr: false,
  }),
  "color-model-converter": dynamic(
    () => import("./color-model-converter").then((m) => m.ColorModelConverter),
    { loading: () => <ToolLoader />, ssr: false },
  ),
  ...
  "base64-image-converter": dynamic(() => import("./base64-image-converter"), {
    loading: () => <ToolLoader />,
    ssr: false,
  }),
