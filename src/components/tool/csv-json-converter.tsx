...
// CSV to JSON — module-level, no state dependencies
...
// JSON to CSV — module-level, no state dependencies
          ...
          <div className="flex items-center justify-center">
            ...
            >
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="csvToJson">{t("csvToJson")}</TabsTrigger>
                <TabsTrigger value="jsonToCsv">{t("jsonToCsv")}</TabsTrigger>
              </TabsList>
            </Tabs>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              placeholder={
                mode === "csvToJson" ? t("enterCsv") : t("enterJson")
              }
