    ...
    <div className="space-y-6">
      <Tabs defaultValue="json-to-toml" onValueChange={handleTabChange}>
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="json-to-toml">{t("jsonToToml")}</TabsTrigger>
          <TabsTrigger value="toml-to-json">{t("tomlToJson")}</TabsTrigger>
        </TabsList>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <h3 className="text-sm font-medium">{t("tomlOutput")}</h3>
                    {output && (
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <h3 className="text-sm font-medium">{t("tomlInput")}</h3>
                  </div>
                  <Textarea
