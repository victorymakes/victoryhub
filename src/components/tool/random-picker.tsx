...
import { Award, Copy, Plus, RefreshCw, Shuffle, Trash } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            {!showBulkInput ? (
              ...
              <div className="space-y-2">
                ...
                />
                <div className="flex space-x-2">
                  <Button onClick={addBulkItems} disabled={!bulkItems.trim()}>
                    <Plus className="h-4 w-4 " />
                    {t("addAll")}
                  </Button>
                  <Button
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          disabled={isSpinning || resultIndex === null}
                          title={t("remove")}
                        >
                          <Trash className="h-4 w-4" />
                        </Button>
