    ...
    <Card>
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold">{`${name} ${t("status")}`}</h2>
          <Button
            variant="outline"
            size="sm"
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          {sites
            ...
            .map((site) => {
              const status = siteStatus.find((s) => s.url === site.url);
                  ...
                  <CardHeader>
                    <CardTitle className="text-xl flex flex-col items-start sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        {site.name || getNameFromUrl(site.url)}
                      </div>
                      <div className="space-x-2">
                        <Badge variant="outline">{t("mainWebsite")}</Badge>
                  ...
                  >
                    <CardHeader>
                      <CardTitle className="text-lg flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          {renderStatusIcon(status)}
                          <span>{site.name || getNameFromUrl(site.url)}</span>
                        </div>
                        {renderStatusBadge(status)}
                      </CardTitle>
                    </CardHeader>
