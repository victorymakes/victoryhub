...
const ImageResizer: React.FC = () => {
  ...
  const addImages = useCallback(
    (files: FileList | File[]) => {
      ...
      Promise.all(imageFiles.map(loadImageDimensions)).then((newImages) => {
  ...
  const handleWidthChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setResizeOptions((prev) => ({
      ...prev,
      width: Number.isNaN(value as number) ? null : value,
    }));
  };
  ...
  const handleHeightChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setResizeOptions((prev) => ({
      ...prev,
      height: Number.isNaN(value as number) ? null : value,
    }));
  };
  ...
  const handleMaxSizeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setResizeOptions((prev) => ({
      ...prev,
      maxSize: Number.isNaN(value) ? 1024 : value,
    }));
  };
      ...
      <Card>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-medium">{t("uploadImages")}</h3>
            <UploadFiles
          ...
          <div className="space-y-4">
            ...
            <RadioGroup
              ...
              onValueChange={(value) =>
                handleResizeModeChange(
                  value as "dimensions" | "percentage" | "maxSize",
                )
              }
              className="space-y-2"
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="dimensions">{t("specificDimensions")}</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="percentage" id="percentage" />
                <Label htmlFor="percentage">{t("percentageResize")}</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="maxSize" id="maxSize" />
                <Label htmlFor="maxSize">{t("maxDimension")}</Label>
              </div>
            </RadioGroup>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label>
                      {t("percentage")}: {resizeOptions.percentage}%
                    </Label>
                  </div>
                  <Slider
            ...
            {resizeOptions.resizeMode === "maxSize" && (
              <div className="space-y-2">
                <Label htmlFor="maxSize">{t("maxDimensionValue")}</Label>
                <Input
                  id="maxSizeValue"
                  type="number"
                  min="1"
                  ...
                  placeholder="1024"
                />
                <p className="text-sm text-gray-500">{t("maxDimensionHelp")}</p>
              </div>
            )}
          </div>
            ...
            <div className="space-y-4 border-t-3 pt-4">
              ...
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium">
                  {images.length}{" "}
                  {images.length === 1 ? t("image") : t("images")}
                </h3>
