      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 border rounded-lg bg-muted/50">
            <h3 className="text-sm font-medium mb-3">{t("currentTime")}</h3>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-mono text-sm">{currentTimestamp}</span>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-mono text-sm">{currentDateTime}</span>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => copyToClipboard(currentDateTime)}
                  >
                    <Copy className="h-3 w-3" />
                  </Button>
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => copyToClipboard(currentDateTimeUTC)}
                  >
                    <Copy className="h-3 w-3" />
                  </Button>
                </div>
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Button
                    variant={dateTime ? "default" : "outline"}
                    size="sm"
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    value={timestamp}
                    readOnly
                    placeholder={t("outputPlaceholderTimestamp")}
                    className="flex-1 font-mono bg-muted/50"
                  />
                  <Button
                    variant={timestamp ? "default" : "outline"}
                    size="sm"
